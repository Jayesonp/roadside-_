    ...
    () => [
      {
        ...
        date: "May 26, 2025 ΓÇó 3:45 PM",
        location: "Downtown Area ΓÇó Provider: QuickFix Auto",
        status: "completed",
        icon: "Γ£à",
      },
      {
        ...
        date: "May 19, 2025 ΓÇó 8:20 AM",
        location: "Highway 101 ΓÇó Provider: RoadHelp Services",
        status: "completed",
        icon: "Γ£à",
      },
      {
        ...
        date: "May 12, 2025 ΓÇó 6:15 PM",
        location: "Mall Parking ΓÇó Reason: Issue resolved",
        status: "cancelled",
        icon: "Γ¥î",
      },
    ],
            ...
            <View className="flex-row justify-between items-center">
              <View className="flex-1">
                ...
                <Text className="text-white/90">
                  {services.find((s) => s.id === activeRequest.type)?.name} ΓÇó{" "}
          ...
          >
            <View className="flex-row justify-between items-center">
              <View className="flex-1">
                ...
                <ResponsiveText variant="body" className="text-white/90">
                  Unlimited services ΓÇó Priority support
                </ResponsiveText>
              </View>
            ...
            <View className="bg-white/5 rounded-2xl p-4 flex-row items-center">
              ...
              <View className="flex-1">
                ...
                <ResponsiveText variant="caption" className="text-green-400">
                  ΓÇó GPS Active ΓÇó Location confirmed
                </ResponsiveText>
              </View>
              <ResponsiveButton
                variant="ghost"
