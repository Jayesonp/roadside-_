        ...
        return (
          <>
            ...
            <Text className="text-slate-500 text-xs">
              {user.totalServices} services ΓÇó {user.totalSpent} spent
            </Text>
          </>
        );
      case "technician":
          ...
          <>
            <View className="flex-row items-center mb-2">
              <Text className="text-slate-400 text-sm">
                ID: {user.techId} ΓÇó Rating: {user.rating}Γ¡É
              </Text>
            </View>
            <View className="flex-row items-center mb-2">
              <View
            ...
            <Text className="text-slate-500 text-xs">
              {user.completedJobs} jobs ΓÇó {user.earnings} earned
            </Text>
          </>
        );
      case "partner":
        return (
          <>
            ...
            <Text className="text-slate-500 text-xs">
              {user.activeUsers} users ΓÇó {user.monthlyRevenue}/month
            </Text>
          </>
        );
      case "admin":
