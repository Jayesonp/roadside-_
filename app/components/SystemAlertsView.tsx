    ...
    useEffect(() => {
      ...
      const interval = setInterval(() => {
        ...
        if (Math.random() < 0.1) {
          ...
          console.log("🔄 Real-time alert update simulated");
        }
      }, 30000);
                  ...
                  <View style={styles.actionButtons}>
                    ...
                    {alert.actionRequired && (
                      <TouchableOpacity style={styles.actionButton}>
                        ...
                        <Text
                          style={[styles.actionButtonText, { marginLeft: 6 }]}
                        >
                          Configure
                        </Text>
                      </TouchableOpacity>
