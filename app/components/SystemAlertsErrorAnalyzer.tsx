      ...
      <View className="bg-slate-800/80 backdrop-blur-lg border border-white/10 rounded-2xl p-6">
        ...
        <View className="mt-6 p-4 bg-slate-700/30 rounded-xl">
          ...
          <Text className="text-slate-400 text-xs mt-2">
            ...
            with: ΓÇó File resolution and import paths ΓÇó Source map generation ΓÇó
            Anonymous file handling ΓÇó StyleSheet or component structure problems
          </Text>
        </View>
        ...
        <View className="mt-4 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
          ...
          <Text className="text-blue-300 text-xs leading-5">
            ΓÇó React Native component structure and syntax{"\n"}ΓÇó State
            management and hooks usage{"\n"}ΓÇó StyleSheet and styling conflicts
            {"\n"}ΓÇó Import/export issues{"\n"}ΓÇó Event handling and callbacks
            {"\n"}ΓÇó Performance and memory considerations
          </Text>
        </View>
      </View>
    </View>
